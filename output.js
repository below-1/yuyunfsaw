module.exports = {
  ...
  output: {
    path: '/home/you/Project13/yuyun-fsaw2/dist',
    filename: '[name].js',
    publicPath: '/',
    globalObject: 'this'
  },
      ...
      /* config.module.rule('vue') */
      {
        ...
        use: [
          /* config.module.rule('vue').use('cache-loader') */
          {
            loader: 'cache-loader',
            options: {
              cacheDirectory: '/home/you/Project13/yuyun-fsaw2/node_modules/.cache/vue-loader',
              cacheIdentifier: '41891916'
            }
          },
      ...
      /* config.module.rule('js') */
      {
        ...
        use: [
          /* config.module.rule('js').use('cache-loader') */
          {
            loader: 'cache-loader',
            options: {
              cacheDirectory: '/home/you/Project13/yuyun-fsaw2/node_modules/.cache/babel-loader',
              cacheIdentifier: '4347c04e'
            }
          },
  ...
  plugins: [
    ...
    new HtmlWebpackPlugin(
      {
        ...
        template: '/home/you/Project13/yuyun-fsaw2/public/index.html'
      }
    ),
    /* config.plugin('pwa') */
    new HtmlPwaPlugin(
    ...
    new CopyWebpackPlugin(
      [
        {
          from: '/home/you/Project13/yuyun-fsaw2/public',
          to: '/home/you/Project13/yuyun-fsaw2/dist',
          toType: 'dir',
          ignore: [
            '.DS_Store'
          ]
