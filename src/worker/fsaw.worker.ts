...
import fuzzyConverter from '@/services/converter/fuzzy'
...
async function fsaw (dataset: string) {
...
export default (input: any, done: any) => {
  return fsaw(input.dataset)
};
